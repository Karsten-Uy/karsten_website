    ...
    <section className="text-left mb-8 text-white">
      ...
      {career.map((job, index) => (
        <Link
          ...
          onMouseEnter={() => {
            handleMouseEnter(job.description);
            setHoveredIndex(job.id);
          }}
          onMouseLeave={() => {
            handleMouseLeave();
        ...
        >
          <motion.div
            ...
            initial="initial"
            animate={hoveredIndex === job.id ? 'hover' : 'initial'}
      ...
      {projects.map((project, index) => (
        <Link
          ...
          className="mb-6 flex flex-wrap relative block group justify-center"
          onMouseEnter={() => {
            handleMouseEnter(project.description);
            setHoveredIndex(project.id);
          }}
          onMouseLeave={() => {
            handleMouseLeave();
            setHoveredIndex(null);
        ...
        >
          <motion.div
            ...
            variants={gradientVariants}
            initial="initial"
            animate={hoveredIndex === project.id ? 'hover' : 'initial'}
            whileHover={{ scale: 0.95 }}
          >
            <div className="w-1/2 text-left p-4 flex flex-col transition-all duration-300">
