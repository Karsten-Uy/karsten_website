  ...
  return (
    <section className="text-center">
        ...
        <div className="flex flex-wrap justify-center gap-0 px-4">
          {[
            { title: 'UI/UX design', class: 'Design intuitive interfaces that enhance user experiences', logo: '/path/to/uiux-logo.png', link: '/uiux' },
            ...
            <div key={index} className="w-full sm:w-1/2 lg:w-1/4 flex ">
              <div className="flex flex-col justify-between w-full bg-primary  rounded-lg shadow-md py-4 mx-2 my-2">
                ...
                <div>
                  <h3 className="text-left font-bold text-xl mb-2 text-black mx-3 text-nonclickblue-gradient">{item.title}</h3>
                  <p className="text-left mb-5 text-black mx-3 text-nonclickblue-gradient">{item.class}</p>
                </div>
              </div>
            </div>
          ))}
